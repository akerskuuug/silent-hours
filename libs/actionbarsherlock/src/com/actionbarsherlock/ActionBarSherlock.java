...
public abstract class ActionBarSherlock {
	...
	private static final HashMap<Implementation, Class<? extends ActionBarSherlock>> IMPLEMENTATIONS = new HashMap<Implementation, Class<? extends ActionBarSherlock>>();
	 ...
	 * {@link Implementation}.
	 */
	public static void registerImplementation(final Class<? extends ActionBarSherlock> implementationClass) {
	 ...
	 */
	public static boolean unregisterImplementation(final Class<? extends ActionBarSherlock> implementationClass) {
	 ...
	 * @return Instance to interact with the action bar.
	 */
	public static ActionBarSherlock wrap(final Activity activity, final int flags) {
	...
	protected ActionBarSherlock(final Activity activity, final int flags) {
		if (DEBUG) {
	 ...
	 */
	public void dispatchPostCreate(final Bundle savedInstanceState) {
	}
	 ...
	 */
	public void dispatchTitleChanged(final CharSequence title, final int color) {
	}
	 ...
	 */
	public boolean dispatchMenuOpened(final int featureId, final android.view.Menu menu) {
		return false;
	}
	 ...
	 * @param menu
	 */
	public void dispatchPanelClosed(final int featureId, final android.view.Menu menu) {
	}
	...
	public void dispatchSaveInstanceState(final Bundle outState) {
	}

	public void dispatchRestoreInstanceState(final Bundle savedInstanceState) {
	}
	 ...
	 */
	protected final boolean callbackOptionsItemSelected(final MenuItem item) {
		if (DEBUG) {
