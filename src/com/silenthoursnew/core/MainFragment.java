...
import com.silenthoursnew.alarm.ScheduleSilenceReceiver;
import com.silenthoursnew.database.AlarmDbAdapter;
import com.silenthoursnew.utility.Constants;
import com.silenthoursnew.utility.MyTimePicker;
...
public class MainFragment extends Fragment implements OnClickListener, OnItemClickListener, OnCheckedChangeListener {
	 ...
	 */
	private Builder createAlarmDialog(final int from, final int to, final boolean enableVibration, final boolean muteMedia, final boolean lockVolume, final boolean unmuteOnCall,
			final boolean disableNotificationLight, final int brightness, final boolean[] wdays, final boolean newAlarm, final int updateAlarmId) {
