...
public class Tools { 
	...
	public static void setAlarm(Context context, AlarmDbAdapter dbAdapter, Alarm alarm, int alarmId){
		...
		// weekdays
		boolean wdays[] =
				new boolean[] { alarm.sunday, alarm.monday, alarm.tuesday, alarm.wednesday,
	...
	public static void setSilent(final Context context, SharedPreferences settings, boolean enableSound, boolean enableVibration,
			boolean muteMedia, boolean lockVolume, boolean unmuteOnCall,
