 ...
 * 
 */
public class ExpandRelativeLayoutAnimation extends Animation {
	private final View mAnimatedView;
	private final android.widget.RelativeLayout.LayoutParams mViewLayoutParams;
	 ...
	 */
	@SuppressLint("NewApi")
	public ExpandRelativeLayoutAnimation(final View view, final int duration) {
